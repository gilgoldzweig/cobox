package com.example.gilgoldzweig.cobox.timber;
 ...
 *
 * An edited script for timber that supports more things
 * and it is part of the classes I just use in all of my projects
 */
public final class Timber {
    ...
    public static final Tree TREE_OF_SOULS = new Tree() {
        ...
        @Override
        public void event(EventableType EventableType, Pair<EventableParam, Object>[] args) {
            Tree[] forest = forestAsArray;
            for (Tree tree : forest) {
        ...
        @Override
        public void event(EventableType EventableType, Bundlify bundlify) {
            Tree[] forest = forestAsArray;
            for (Tree tree : forest) {
...
//    }
     ...
     */
    @SafeVarargs
    public static void event(EventableType EventableType, Pair<EventableParam, Object>... args) {
        TREE_OF_SOULS.event(EventableType, args);
    }

    public static void event(EventableType EventableType, Bundlify bundlify) {
    ...
    public static abstract class Tree {
        ...
        public abstract void event(EventableType EventableType, Pair<EventableParam, Object>... args);

        public abstract void event(EventableType EventableType, Bundlify bundlify);
        ...
        public boolean equals(Object o) {
            ...
            Tree tree = (Tree) o;
            return Objects.equals(explicitTag, tree.explicitTag);
        }

        @Override
        public int hashCode() {
            return Objects.hash(explicitTag);
        }
    }
    ...
    public static class DebugTree extends Tree {
        ...
        public void event(EventableType eventableType, Pair<EventableParam, Object>[] args) {
            if (args.length == 0) {
                d("event: %s", eventableType.toString());
            } else {
                d("event: %s args: %s", eventableType.toString(), buildPairArgsString(args));
            }
        ...
        public void event(EventableType eventableType, Bundlify bundlify) {
            ...
            if (bundlify.isEmpty()) {
                ...
                d("event: %s args: %s", eventableType.toString(), bundlify.toString());
            }
        ...
        private String buildPairArgsString(Pair<EventableParam, Object>[] args) {
            if (args.length == 0) return "Empty";
            StringBuilder builder = new StringBuilder();
            builder.append("[");
            for (Pair<EventableParam, Object> pair : args) {
